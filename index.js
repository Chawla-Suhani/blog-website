...
app.get("/posts/:id",(req,res) => {
  ...
  const getPost = posts.find((post)=>{ return post.id == resId})
...
app.patch("/posts/:id",(req,res) =>{
  ...
  const currentPost = posts.find((post)=>post.id == idResponse)
  const currentPostIndex = posts.findIndex((post)=>post.id == idResponse)
  const updatePost = {
     id:idResponse,
  ...
  res.json(updatePost);
  posts[currentPostIndex] = updatePost;
...
app.delete("/posts/:id",(req,res) => {
  ...
  const resId = req.params.id;
  const deletePost = posts.findIndex((post)=>{ post.id == resId});
